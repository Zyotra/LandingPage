            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full h-12 text-[#1a1a22] font-bold py-3 rounded-lg hover:brightness-90 transition flex items-center justify-center disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
                    <>
                      <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-[#1a1a22]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
