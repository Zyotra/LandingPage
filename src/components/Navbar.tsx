...
const Navbar = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? 'px-4 md:px-6 lg:px-8 pt-3' : 'px-0 pt-0'
      }`}>
      <nav className={`mx-auto transition-all duration-500 relative ${scrolled
        ...
        {/* Main Navbar Content */}
        <div className={`flex items-center justify-between relative transition-all duration-500 ${scrolled ? 'px-4 md:px-6 py-3' : 'max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-4'
          }`}>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            >
              ...
              {/* Dropdown Menu */}
              <div
                className={`absolute top-full left-1/2 -translate-x-1/2 pt-3 transition-all duration-200 ${productsOpen ? 'opacity-100 visible translate-y-0' : 'opacity-0 invisible -translate-y-2'
                  }`}
              >
